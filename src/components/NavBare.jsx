...
const NavBare = () => {
  ...
  const NavLinks = () => {
    const links = [
      ...
      { name: 'Expense', href: '/expense', icon: <MdPayment size={18} /> },
      { name: 'Promise Users', href: '/promise-date', icon: <MdHandshake size={18} /> },
      { name: 'Total Collections', href: '/total-collections', icon: <MdBarChart size={18} /> },
      { name: 'Unpaid Users', href: '/unpaid-users', icon: <MdPeopleOutline size={18} /> },
      ...
      <div className="navbar container mx-auto px-4 md:px-6 min-h-[56px] flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="dropdown md:hidden">
            ...
            <ul
              tabIndex={0}
              className="dropdown-content menu menu-sm z- mt-3 w-52 p-2 shadow bg-white border border-gray-100 rounded-xl gap-1"
            >
              <NavLinks />
            </ul>
          </div>
        ...
        {/* 💻 ডেক্সটপ নেভিগেশন মেনু (মাঝারি ও বড় স্ক্রিনের জন্য) */}
